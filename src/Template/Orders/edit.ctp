...
<?php 
    ...
    foreach ($equipment_types as $key => $value) {
        ...
        if(preg_match("/([\s　]*". $value .")/", $order->description,$match)){
            $original_desc = $match[1];
        }
...
//start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD'));
    ...
    $(".sub_item_name").on("change",function(){
       ...
       var str_desc = description.join(" ") + original_desc;
       
        $("#description").val(str_desc);       
        ...
        <div class="content">
          ...
          <div class="clearfix">
            ...
            <div class="form-group clearfix">
                <span class="formData" id="equipmentA-id">
                    <?php if(!empty($work->equipment1)) echo $work->equipment1->equipment_type->name . " " . $work->equipment1->equipment_no . "号車"; ?></span>
            </div>
            </div>

                <div class="col-md-3">        
            <div class="form-group clearfix">
                <span class="formData" id="equipmentB-id">
                    <?php if(!empty($work->equipment2)) echo $work->equipment2->equipment_type->name . " " . $work->equipment2->equipment_no . "号車"; ?></span>
            </div>
            </div>   
                ...
                <div class="col-md-3">        
            <div class="form-group clearfix">
                <span class="formData" id="equipmentC-id">
                    <?php if(!empty($work->equipment3)) echo $work->equipment3->equipment_type->name . " " . $work->equipment3->equipment_no . "号車"; ?></span>
            </div>
            </div>   
                ...
                <div class="col-md-3">        
            <div class="form-group clearfix">
                <span class="formData" id="equipmentD-id">
                    <?php if(!empty($work->equipment4)) echo $work->equipment4->equipment_type->name . " " . $work->equipment4->equipment_no . "号車"; ?></span>
            </div>
            </div>  

                <div class="col-md-3">        
            <div class="form-group clearfix">
                <span class="formData" id="equipmentE-id">
                    <?php if(!empty($work->equipment5)) echo $work->equipment5->equipment_type->name . " " . $work->equipment5->equipment_no . "号車"; ?></span>
            </div>
            </div>   


            </div>
            <div class="clearfix voffset4">
