...
////////////////jqgrid
   ...
   // ロケールを設定
    ...
    $('#bill-sent-date,#due-date').daterangepicker({
        format:'YYYY/MM/DD',
...
<small>選択した注文情報から請求書を新規作成します</small>
</h1>
</section>
...
<div class="box box-danger">
  ...
  <div class="box-body">
        ...
        <legend><?php echo __('請求書新規作成'); ?></legend>   
<div class="billadd form">              
    ...
    <?php echo $this->Form->input('data.check_str', array(
        'type'=>'hidden',
        'value'=>$check_str
    )); ?>   
...
<hr />  
    ...
    <?php
        ...
        'type'=>'button',
        'onclick'=>'Javascript:saveBillData();return false;'
        )   
        );
        echo "&nbsp;&nbsp;&nbsp;";
        echo $this->Html->link(
